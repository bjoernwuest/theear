...
public final class FunctionalPermissionGroup {
  ...
  final Set<Reference<FunctionalPermission>> _AssignedFunctionalPermissions = new TreeSet<>();
  ...
  public final Set<Reference<FunctionalPermission>> AssignedFunctionalPermissions = Collections.unmodifiableSet(this._AssignedFunctionalPermissions);
   ...
   */
  public void grant(@Nonnull Reference<FunctionalPermission> PermissionToGrant) { this.m_Repo.grant(PermissionToGrant, this.m_Repo.getFunctionalPermissionGroup(this.FunctionalPermissionGroupID).get()); }
   ...
   */
  public void revoke(@Nonnull Reference<FunctionalPermission> PermissionToRevoke) { this.m_Repo.revoke(PermissionToRevoke, this.m_Repo.getFunctionalPermissionGroup(this.FunctionalPermissionGroupID).get()); }
}
