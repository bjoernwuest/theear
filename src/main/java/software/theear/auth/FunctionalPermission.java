...
public final class FunctionalPermission {
  ...
  final Set<Reference<FunctionalPermissionGroup>> _AssignedFunctionalPermissionGroups = new TreeSet<>();
  ...
  /** The {@link org.apache.wicket.authorization.Action action} this functional permission controls. */
  ...
  public final Set<Reference<FunctionalPermissionGroup>> AssignedFunctionalPermissionGroups = Collections.unmodifiableSet(this._AssignedFunctionalPermissionGroups);
  
  FunctionalPermission(@Nonnull UUID FunctionalPermissionID, @Nonnull String PermissionName, @Nonnull String PermissionAction, @Nonnull String PermissionDescription, @Nonnull Instant CreatedAt, @Nonnull Instant LastSeenAt) {
