...
public final class OidcUser extends DefaultOidcUser {
  ...
  @Autowired private DatabaseService m_DBService;
   ...
   */
  public static boolean hasAllPermissions(OidcUser User, FunctionalPermissionsEnum[] Permissions) { return (null != User) ? User.isRoot() || User.hasAllPermissions(Permissions) : false; }
